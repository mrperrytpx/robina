    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-50 w-full rounded-t-lg bg-indigo-600 p-4 py-8 text-center text-white sm:bottom-2 sm:left-2 sm:w-[500px] sm:rounded-lg">
            ...
            <button
                ...
                className="mt-4 rounded-lg border-2 border-white bg-white px-4 py-2 font-semibold text-black hover:border-black hover:text-sky-500 focus:border-black focus:text-sky-500"
            >
                I understand
            </button>
        </div>
